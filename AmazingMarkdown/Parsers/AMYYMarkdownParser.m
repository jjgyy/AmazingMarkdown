...
@implementation AMYYMarkdownParser {
    UIFont *_font;
...
- (void)setFontSize:(CGFloat)fontSize {
    ...
    for (int i=5; i>=0; --i) {
        [mutableHeaderFonts addObject:[UIFont boldSystemFontOfSize:fontSize+(4*i)]];
    }
...
- (void)setTheme:(DYMarkdownTheme)theme {
    ...
    _controlTextColor = UIColor.flatSkyBlueColorDark;
