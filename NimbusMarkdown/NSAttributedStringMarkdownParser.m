...
static NSAttributedStringMarkdownParser * _sharedParser;
+ (NSAttributedStringMarkdownParser *)sharedParser {
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedParser = [[NSAttributedStringMarkdownParser alloc] init];
    });
